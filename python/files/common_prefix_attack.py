...
def execute_transaction1():
    os.system("docker exec -it validator_4 /bin/bash -c '/transaction1.sh'")


def execute_transaction_dest1():
    sem1.release()
    sem2.acquire()
    os.system("docker exec -it validator_4 /bin/bash -c '/transaction_dest1.sh'")
...
def execute_transaction_dest2():
    sem1.acquire()
    sem2.release()
    os.system("docker exec -it validator_4p /bin/bash -c '/transaction_dest2.sh'")
